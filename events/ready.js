...
module.exports = class {
  ...
  async run() {
    ...
    const statusArray = [
      client =>
        client.user.setActivity("https://lutu.botcord.site | %help", {
          type: "WATCHING"
        }),
      client =>
        client.user.setActivity(
          "https://discord.io/Underground_Server | %help",
          { type: "WATCHING" }
        ),
      client =>
        client.user.setActivity(`${this.client.users.size} users | %help`, {
          type: "WATCHING"
        })
    ];
    ...
    this.client.logger.log(
      `Logged in as ${this.client.user.tag}! Serving ${this.client.guilds.size} Servers and ${users} Users.`,
      "ready"
    );
